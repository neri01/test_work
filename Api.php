...
abstract class Api
{
    ...
    public function run() {
        ...
        $this->action = $this->requestParams['function'];

        $file = fopen("logger.txt", "a");
        fwrite($file, "в процессе обработки функции ".$this->requestParams['function']. "\n");
        fclose($file);
    ...
    abstract protected function remember_password();
    abstract protected function get_posts();
    abstract protected function add_post();
